        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 form-group">
                        <label class="col-md-2">Theo giờ: </label>
                        <label class="col-md-1">Từ</label>
                        ...
                        <div class="col-md-2">
                        	<select id="hour" name="hour">
                        		...
                        		<option value="1">Hôm sau</option>
                        	</select>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12"></div>
                    <div class="col-md-9 col-sm-9 col-xs-12 form-group">
                        <label class="col-md-2">Qua đêm: </label>
                        <label class="col-md-1">Từ</label>
            ...
            <div class="x_content">
                <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" class="form-control" name="address" id="address" value="Hà Nội, Vietnam" placeholder="" >
