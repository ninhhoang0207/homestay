    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 form-group">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">@lang('hotel/general.sophongdon') *</label>
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <input class="form-control" type="number" min="0" name="singleroom_number" id="singleroom_number" value="{{$data->so_phongdon}}">
                        </div>
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">@lang('hotel/general.dientich') *</label>
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <input class="form-control" type="number" min="0" name="singleroom_square" id="singleroom_square" value="{{$data->dientich_phongdon}}">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">@lang('hotel/general.sophongdoi') *</label>
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <input class="form-control" type="number" min="0" name="doubleroom_number" id="doubleroom_number" value="{{$data->so_phongdoi}}">
                        </div>
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">@lang('hotel/general.dientich') *</label>
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <input class="form-control" type="number" min="0" name="doubleroom_square" id="doubleroom_square" value="{{$data->dientich_phongdoi}}">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">@lang('hotel/general.sophongkhac') *</label>
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <input class="form-control" type="number" min="0" name="otherroom_number" id="otherroom_number" value="{{$data->so_phongkhac}}">
                        </div>
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">@lang('hotel/general.dientich') *</label>
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <input class="form-control" type="number" min="0" name="otherroom_square" id="otherroom_square" value="{{$data->dientich_phongkhac}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 form-group">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">@lang('hotel/general.trangthaihoatdong')</label>
                        <div class="col-md-9 con-sm-9 col-xs-12">
                            <input type="checkbox" class="flat" name="status" id="status" value="{{$data->trangthai}}" {{$data->trangthai=="hoatdong"?"checked":""}}>
                        </div>
                    </div>
                </div>
            </div>
