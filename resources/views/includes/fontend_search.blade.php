         ...
         <div class="slider-w" data-u="slides">
            <div>
               ...
               <div class="slider-caption" data-u="caption" data-t="0" >
                  <img class="slider-img1" src="{{ asset('fontend/img/c-phone.png') }}" alt="imgshow-phone">
                  <img class="slider-img2" data-u="caption" data-t="1"  src="{{ asset('fontend/img/c-jssor-slider.png') }}" alt="imgshow-phone"/>
                  <img class="slider-img3" data-u="caption" data-t="2" src="{{ asset('fontend/img/c-text.png') }}" alt="imgshow-phone" />
                  <img class="slider-img4" data-u="caption" data-t="3" src="{{ asset('fontend/img/c-fruit.png') }}" alt="imgshow-phone" />
                  <img class="slider-img5" data-u="caption" data-t="4" src="{{ asset('fontend/img/c-navigator.png') }}" alt="imgshow-phone" />
               </div>
               <div class="slider-caption2" data-u="caption" data-t="5" >
                  <img class="slider-img" src="{{ asset('fontend/img/c-phone-horizontal.png') }}" alt="imgshow-phone"/>
                  <div  class="slider-next-img" >
                     <img class="slider-img6" data-u="caption" data-t="6" src="{{ asset('fontend/img/c-slide-1.jpg') }}" alt="imgshow-phone" />
                     <img class="slider-img7" data-u="caption" data-t="7" src="{{ asset('fontend/img/c-slide-3.jpg') }}" alt="imgshow-phone"/>
                   </div>
                  <img class="slider-img8" src="{{ asset('fontend/img/c-navigator-horizontal.png') }}" alt="imgshow-phone"/>
                  <img class="slider-img9" data-u="caption" data-t="8" src="{{ asset('fontend/img/c-finger-pointing.png') }}" alt="imgshow-phone" />
               </div>
            </div>
            <div>
               <img data-u="image" src="{{ asset('fontend/img/fslide02.jpg') }}" alt="imgshow-phone"/>
            </div>
            <div>
               <img data-u="image" src="{{ asset('fontend/img/nen2.jpg') }}" alt="imgshow-phone"/>
            </div>
         </div>
          <!-- Bullet Navigator -->
   ...
   <div id="carousel-example-generic" class="carousel slide hidden-lg" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
         <div class="item active">
            <img src="{{ asset('fontend/img/hnen1.jpg') }}" alt="slide-image">
      ...
      <div class="row">
         <div class="col-xs-12 col-sm-12 ">
            <div class="col-xs-12 col-sm-4 col-sm-offset-4 ">
               <h1>@lang('hotel/general.trangchu.timkiemnhanghi')</h1>
            </div><!--End col-sm-12 -->
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
               <div class="col-xs-12 col-sm-5">
                  <h5>@lang('hotel/general.trangchu.noitimkiem')</h5>
                  <div class="form-input">
                     <input id="address" name="address" type="text" class="form-control form-box" placeholder="@lang('hotel/general.trangchu.tenvitri')...">
                     <i class="map-maker"></i>
               ...
               <div class="col-xs-2 col-sm-1 hidden-xs">
                  <h5>@lang('hotel/general.trangchu.thoigian')</h5>
               ...
               <div class="col-sm-3 features hidden-xs">
                  ...
                  <div class="feature">@lang('hotel/general.trangchu.quangcao1')</div>
               </div>
               <div class="col-sm-3 features hidden-xs">
                  <img src="{{ asset('fontend/images/iconcash.png') }}" alt="">
                  <div class="feature">@lang('hotel/general.trangchu.quangcao2')</div>
               </div>
               <div class="col-sm-3 features hidden-xs">
                  <img src="{{ asset('fontend/images/iconcup.png') }}" alt="">
                  <div class="feature">@lang('hotel/general.trangchu.quangcao3')</div>
               </div>
               <div class="col-sm-3 features hidden-xs">
                  <img src="{{ asset('fontend/images/iconcash.png') }}" alt="">
                  <div class="feature">@lang('hotel/general.trangchu.quangcao4')</div>
               </div>
