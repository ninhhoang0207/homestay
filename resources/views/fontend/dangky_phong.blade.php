...
<form method="POST" action="{{route('bookroom')}}" class="form-group" id="dangky_phong">
	<section>
		<div class="container">
			<div class="row">
...
<script type="text/javascript">
	$('#dangky_phong').validate({
		...
		messages : {
			ho : "{{Lang::get('bookroom/validation.messages')}}",
			ten : "{{Lang::get('bookroom/validation.messages')}}",
			thoigianden : "{{Lang::get('bookroom/validation.messages')}}",
			thoigiantra : "{{Lang::get('bookroom/validation.messages')}}",
			songuoi : "{{Lang::get('bookroom/validation.messages')}}",
			sophong : "{{Lang::get('bookroom/validation.messages')}}",
			sdt : "{{Lang::get('bookroom/validation.messages')}}",
			loaiphong : "{{Lang::get('bookroom/validation.messages')}}",
		}
	});
</script>
<script>
	...
	$('#thoigianden').on('change', function(){
		...
		if (thoigiantra != ''){
			var thoigianden_theogio = "{{$data->thoigianden_theogio}}";
			thoigianden_theogio = parseInt(thoigianden_theogio.split(':')[0]);
			var thoigianden_quadem = "{{$data->thoigianden_quadem}}";
			thoigianden_quadem = parseInt(thoigianden_quadem.split(':')[0]);
			var thoigiantra_theogio = "{{$data->thoigiantra_theogio}}";
			thoigiantra_theogio = parseInt(thoigiantra_theogio.split(':')[0]);
			var thoigiantra_quadem = "{{$data->thoigiantra_quadem}}";
			thoigiantra_quadem = parseInt(thoigiantra_quadem.split(':')[0]);
			var loai_thoigiantra_theogio = "{{$data->loai_thoigiantra_theogio}}";
			var loai_thoigiantra_quadem = "{{$data->loai_thoigiantra_quadem}}";
